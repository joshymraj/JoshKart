...
public class ArcadeKart : MonoBehaviour {
    ...
    void GatherInputs()
    {
        ...
        {
            Input = ControlInput.GenerateInput();
            WantsToDrift = Input.Accelerate && Input.Brake && Math.Abs(Input.TurnInput) > 0;
        }
    ...
    {
        //Debug.Log(string.Format("Move Vehicle A:{0}, B:{1}, T:{2}", accelerate, brake, turnInput));
